...
function ThemeToggle({ initialTheme }: ThemeToggleProps) {
  ...
  return (
    <div className="bg-neutral-200 dark:bg-neutral-800 p-px rounded-full relative shadow-sm shadow-neutral-400 dark:shadow-black z-0 shrink-0 dark:border dark:border-neutral-600">
      <button
