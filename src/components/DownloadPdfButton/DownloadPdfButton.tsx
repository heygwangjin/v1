...
function DownloadPdfButton({
  ...
  return (
    <a
      ...
      target="_blank"
      className={cn(
        'bg-neutral-200 dark:bg-neutral-800 p-px rounded-full shadow-sm shadow-neutral-400 dark:shadow-black group outline-none focus-visible:ring-1 ring-neutral-950 dark:ring-neutral-50 h-11',
        className
      )}
    ...
    >
      <div
        className={cn(
          'w-full h-full flex justify-center items-center gap-1 py-3 px-4 rounded-full z-20',
